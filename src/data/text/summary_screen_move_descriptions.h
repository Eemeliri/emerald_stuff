...
static const u8 sMoveFourLineDescription_DireClaw[] = _("High critical hit chance. May\nparalyze, poison or drowse.");

static const u8 sMoveFourLineDescription_PsyshieldBash[] = _("Hits a foe with psychic\nenergy. May raise Defense.");

static const u8 sMoveFourLineDescription_PowerShift[] = _("The user swaps its Attack\nand Defense stats.");

static const u8 sMoveFourLineDescription_StoneAxe[] = _("High critical hit ratio. Sets\nSplinters that hurt the foe.");

static const u8 sMoveFourLineDescription_SpringtideStorm[] = _("Wraps a foe in fierce winds.\nVaries with the user's form.");

static const u8 sMoveFourLineDescription_MysticalPower[] = _("A mysterious power strikes,\nraising the user's Sp. Atk.");

static const u8 sMoveFourLineDescription_RagingFury[] = _("A rampage of 2 to 3 turns\nthat confuses the user.");

static const u8 sMoveFourLineDescription_WaveCrash[] = _("A slam shrouded in water.\nIt also hurts the user.");

static const u8 sMoveFourLineDescription_Chloroblast[] = _("A user-hurting blast of\namassed chlorophyll.");

static const u8 sMoveFourLineDescription_MountainGale[] = _("Giant chunks of ice damage\nthe foe. It may flinch.");

static const u8 sMoveFourLineDescription_VictoryDance[] = _("Dances to raise Attack,\nDefense and Speed.");

static const u8 sMoveFourLineDescription_HeadlongRush[] = _("Hits with a full-body tackle.\nLowers the users's defenses.");

static const u8 sMoveFourLineDescription_BarbBarrage[] = _("Can poison on impact. Powers\nup against poisoned foes.");

static const u8 sMoveFourLineDescription_EsperWing[] = _("High critical hit ratio.\nUps the user's Speed.");

static const u8 sMoveFourLineDescription_BitterMalice[] = _("A spine-chilling resentment.\nMay lower the foe's Attack.");

static const u8 sMoveFourLineDescription_Shelter[] = _("The user hardens their skin,\nsharply raising its Defense.");

static const u8 sMoveFourLineDescription_TripleArrows[] = _("High critical hit ratio.\nMay lower Defense or flinch.");

static const u8 sMoveFourLineDescription_InfernalParade[] = _("Hurts a foe harder if it has\nan ailment. May leave a burn.");

static const u8 sMoveFourLineDescription_CeaselessEdge[] = _("High critical hit ratio. Sets\nSplinters that hurt the foe.");

static const u8 sMoveFourLineDescription_BleakwindStorm[] = _("Hits with brutal, cold winds.\nMay lower the foe's Speed.");

static const u8 sMoveFourLineDescription_WildboltStorm[] = _("Hits with a brutal tempest.\nMay inflict paralysis.");

static const u8 sMoveFourLineDescription_SandsearStorm[] = _("Hits with brutally hot sand.\nMay inflict a burn.");

static const u8 sMoveFourLineDescription_LunarBlessing[] = _("The user heals and cures\nitself and its ally.");

static const u8 sMoveFourLineDescription_TakeHeart[] = _("The user lifts its spirits to\nheal and strengthen itself.");

static const u8 sMoveFourLineDescription_TeraBlast[] = _("If the user's Terastallized,\nit hits with its Tera-type.");

static const u8 sMoveFourLineDescription_SilkTrap[] =_("Protects itself, lowering\nSpeed on contact.");

static const u8 sMoveFourLineDescription_AxeKick[] = _("May miss and hurt the kicker.\nMay cause confusion.");

static const u8 sMoveFourLineDescription_LastRespects[] = _("This move deals more damage\nfor each defeated ally.");

static const u8 sMoveFourLineDescription_LuminaCrash[] = _("A mind-affecting light\nharshly lowers Sp. Def.");

static const u8 sMoveFourLineDescription_OrderUp[] = _("Boosts a user's stats\ndepending on Tatsugiri.");

static const u8 sMoveFourLineDescription_JetPunch[] = _("A punch is thrown at blinding\nspeed to strike first.");

static const u8 sMoveFourLineDescription_SpicyExtract[] = _("Sharply ups target's Attack,\nharshly lowers its Defense.");

static const u8 sMoveFourLineDescription_SpinOut[] = _("Furiously strains its legs.\nHarshly lowers user's Speed.");

static const u8 sMoveFourLineDescription_PopulationBomb[] = _("The user's fellows hit one\nto ten times in a row.");

static const u8 sMoveFourLineDescription_IceSpinner[] = _("Ice-covered feet hit a foe\nand destroy the terrain.");

static const u8 sMoveFourLineDescription_GlaiveRush[] = _("Foe attacks next turn can't\nmiss and do double damage.");

static const u8 sMoveFourLineDescription_RevivalBlessing[] = _("Revives a fainted party {PKMN}\nand restores half of its HP.");

static const u8 sMoveFourLineDescription_SaltCure[] = _("Hurts foe every turn. Double\ndamage to Steel and Water.");

static const u8 sMoveFourLineDescription_TripleDive[] = _("Hits target with splashes\nof water 3 times in a row.");

static const u8 sMoveFourLineDescription_MortalSpin[] = _("Erases trap moves and Leech\nSeed. Poisons adjecent foes.");

static const u8 sMoveFourLineDescription_Doodle[] = _("Changes user's and ally's\nAbility into the target's.");

static const u8 sMoveFourLineDescription_FilletAway[] = _("Sharply boosts offenses and\nSpeed by using its own HP.");

static const u8 sMoveFourLineDescription_KowtowCleave[] = _("User slashes the foe after\nkowtowing. It never misses.");

static const u8 sMoveFourLineDescription_FlowerTrick[] = _("Rigged bouquet. Always gets\na critical hit, never missing.");

static const u8 sMoveFourLineDescription_TorchSong[] = _("Flames scorch the target.\nBoosts the user's Sp. Atk.");

static const u8 sMoveFourLineDescription_AquaStep[] = _("Hits with light, fluid dance\nsteps. Ups the user's Speed.");

static const u8 sMoveFourLineDescription_RagingBull[] = _("Tackle that breaks barriers.\nUser's form determines type.");

static const u8 sMoveFourLineDescription_MakeItRain[] = _("Lowers the user's Sp. Atk.\nMoney is recovered after.");

static const u8 sMoveFourLineDescription_Ruination[] = _("Summons a ruinous disaster\nand cuts half the foe's HP.");

static const u8 sMoveFourLineDescription_CollisionCourse[] = _("Prehistoric explosion that's\nstronger if supereffective.");

static const u8 sMoveFourLineDescription_ElectroDrift[] = _("Futuristic electricity. It's\nstronger if supereffective.");

static const u8 sMoveFourLineDescription_ShedTail[] = _("Creates a Substitute for\nitself before switching out.");

static const u8 sMoveFourLineDescription_ChillyReception[] =_("Bad joke summons snowstorm.\nThe user also switches out.");

static const u8 sMoveFourLineDescription_TidyUp[] = _("User tidies up hazards and\nraises its Attack and Speed.");

static const u8 sMoveFourLineDescription_Snowscape[] = _("Summons a snowstorm that\nlasts for five turns.");

static const u8 sMoveFourLineDescription_Pounce[] = _("The user pounces on the foe,\nlowering its Speed.");

static const u8 sMoveFourLineDescription_Trailblaze[] = _("The user attacks suddenly,\nraising its Speed.");

static const u8 sMoveFourLineDescription_ChillingWater[] = _("A shower with ice-cold water\nlowers the target's Attack.");

static const u8 sMoveFourLineDescription_HyperDrill[] = _("A spinning pointed part\nbypasses a foe's Protect.");

static const u8 sMoveFourLineDescription_TwinBeam[] = _("Mystical eye-beams that hit\nthe target twice in a row.");

static const u8 sMoveFourLineDescription_RageFist[] = _("The more the user has been\nhit, the stronger the move.");

static const u8 sMoveFourLineDescription_ArmorCannon[] = _("A strong attack but lowers\nthe defensive stats.");

static const u8 sMoveFourLineDescription_BitterBlade[] = _("An attack that absorbs\nhalf the damage inflicted.");

static const u8 sMoveFourLineDescription_DoubleShock[] = _("Discharges all electricity,\nlosing the Electric type.");

static const u8 sMoveFourLineDescription_GigatonHammer[] = _("Swings a huge hammer. Can't\nbe used twice in a row.");

static const u8 sMoveFourLineDescription_Comeuppance[] = _("Retaliates strongly against\nwho last hurt the user.");

static const u8 sMoveFourLineDescription_AquaCutter[] = _("Pressurized water cut with a\nhigh critical-hit ratio.");
...
static const u8 sMoveFourLineDescription_Psyblade[] = _("This move's power increases\nwhen on Electric Terrain.");

static const u8 sMoveFourLineDescription_HydroSteam[] = _("This move's power increases\nunder harsh sunlight.");

static const u8 sMoveFourLineDescription_BloodMoon[] = _("Unleashes the blood moon.\nCan't be used twice in a row.");

static const u8 sMoveFourLineDescription_MatchaGotcha[] = _("Absorbs half the damage\ninflicted. May cause a burn.");

static const u8 sMoveFourLineDescription_SyrupBomb[] = _("Lowers the foe's\n speed each\nturn for 3 turns.");

static const u8 sMoveFourLineDescription_IvyCudgel[] = _("Type changes with \nheld mask."" High\ncritical-hit ratio.");

static const u8 sMoveFourLineDescription_ElectroShot[] = _("Absorbs electricity in one turn,\nthen attacks next turn.");

static const u8 sMoveFourLineDescription_TeraStarstorm[] = _("Damages all opponents if user is\nStellar form Terapagos.");

static const u8 sMoveFourLineDescription_FickleBeam[] = _("Shoots a beam of light. Sometimes\ntwice as strong.");

static const u8 sMoveFourLineDescription_BurningBulwark[] = _("Evades attack, and burns\nthe foe if struck.");

static const u8 sMoveFourLineDescription_TachyonCutter[] = _("Launches particle blades at\nthe target. Strikes twice.");

static const u8 sMoveFourLineDescription_DragonCheer[] = _("Increases allies' critical hit\nration, especially if Dragons.");

static const u8 sMoveFourLineDescription_AlluringVoice[] = _("Confuses the target if their\nstats were boosted this turn.");

static const u8 sMoveFourLineDescription_TemperFlare[] = _("A desperation attack. Power\ndoubles if last move failed.");

static const u8 sMoveFourLineDescription_SupercellSlam[] = _("An electrified slam. If it\nmisses, the user is hurt.");

static const u8 sMoveFourLineDescription_PsychicNoise[] = _("Unpleasant sound waves that\ndamage and prevent healing.");

static const u8 sMoveFourLineDescription_UpperHand[] = _("Makes the target flinch if\nreadying a priority move.");

static const u8 sMoveFourLineDescription_MalignantChain[] = _("A corrosive chain attack\nthat may badly poison.");
...
const u8 *const gMoveFourLineDescriptionPointers[MOVES_COUNT - 1] = {
    ...
    [MOVE_HIDDEN_POWER_GROUND - 1] = sMoveFourLineDescription_HiddenPower,
    [MOVE_HIDDEN_POWER_GRASS - 1] = sMoveFourLineDescription_HiddenPower,
    [MOVE_HIDDEN_POWER_FIGHTING - 1] = sMoveFourLineDescription_HiddenPower,
    [MOVE_HIDDEN_POWER_FIRE - 1] = sMoveFourLineDescription_HiddenPower,
    [MOVE_HIDDEN_POWER_ROCK - 1] = sMoveFourLineDescription_HiddenPower,
    [MOVE_HIDDEN_POWER_ELECTRIC - 1] = sMoveFourLineDescription_HiddenPower,
    [MOVE_HIDDEN_POWER_ICE - 1] = sMoveFourLineDescription_HiddenPower,
    [MOVE_HIDDEN_POWER_WATER - 1] = sMoveFourLineDescription_HiddenPower,
    [MOVE_HIDDEN_POWER_FLYING - 1] = sMoveFourLineDescription_HiddenPower,
