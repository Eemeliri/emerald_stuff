...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_VAJRA_DESERT] = MAPPOPUP_THEME_STONE2,
    [MAPSEC_VAJRA_PYRAMID] = MAPPOPUP_THEME_STONE2,
    [MAPSEC_VAJRA_VILLAGE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE_135] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_LUMI_VILLAGE] = MAPPOPUP_THEME_BRICK,
    [MAPSEC_FROSTWARD_MOUNTAIN] = MAPPOPUP_THEME_STONE,
    [MAPSEC_FOGBOUND_LAKE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ACUITY_CAVE] = MAPPOPUP_THEME_STONE,
    [MAPSEC_NEWMOON_ISLAND] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_FULLMOON_ISLAND] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_CERULEAN_CAVE] = MAPPOPUP_THEME_STONE,
    [MAPSEC_STARK_MOUNTAIN] = MAPPOPUP_THEME_STONE2,
    ...
    [MAPSEC_SLATEPORT_MARKET - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_NAMELESS_CAVERN  - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
    [MAPSEC_LAKE_VALOR  - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_CAVE_OF_VALOR  - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
    [MAPSEC_SOUTHERN_WILDS  - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_NORTHERN_WILDS  - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_DEWFORD_WOODS] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_DEWFORD_DOJO] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_SHAMOUTI_ISLAND] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_RUGGED_ROAD] = MAPPOPUP_THEME_WOOD,
