...
const u8 *const gMonIconTable[] =
{
    ...
    [SPECIES_VENUSAUR_MEGA_GMAX] = gMonIcon_VenusaurMegaGmax,
    [SPECIES_CHARIZARD_MEGA_GMAX] = gMonIcon_CharizardMegaGmax,
    [SPECIES_BLASTOISE_MEGA_GMAX] = gMonIcon_BlastoiseMegaGmax,
    [SPECIES_BUTTERFREE_MEGA_GMAX] = gMonIcon_ButterfreeMegaGmax,
    [SPECIES_PIKACHU_MEGA_GMAX] = gMonIcon_PikachuMegaGmax,
    [SPECIES_MACHAMP_MEGA_GMAX] = gMonIcon_MachampMegaGmax,
    [SPECIES_GENGAR_MEGA_GMAX] = gMonIcon_GengarMegaGmax,
    [SPECIES_KINGLER_MEGA_GMAX] = gMonIcon_KinglerMegaGmax,
    [SPECIES_LAPRAS_MEGA_GMAX] = gMonIcon_LaprasMegaGmax,
    [SPECIES_EEVEE_MEGA_GMAX] = gMonIcon_EeveeMegaGmax,
    [SPECIES_SNORLAX_MEGA_GMAX] = gMonIcon_SnorlaxMegaGmax,
    [SPECIES_GARBODOR_MEGA_GMAX] = gMonIcon_GarbodorMegaGmax,
    [SPECIES_MELMETAL_MEGA_GMAX] = gMonIcon_MelmetalMegaGmax,
    [SPECIES_RILLABOOM_MEGA_GMAX] = gMonIcon_RillaboomMegaGmax,
    [SPECIES_CINDERACE_MEGA_GMAX] = gMonIcon_CinderaceMegaGmax,
    [SPECIES_INTELEON_MEGA_GMAX] = gMonIcon_InteleonMegaGmax,
    [SPECIES_CORVIKNIGHT_MEGA_GMAX] = gMonIcon_CorviknightMegaGmax,
    [SPECIES_ORBEETLE_MEGA_GMAX] = gMonIcon_OrbeetleMegaGmax,
    [SPECIES_DREDNAW_MEGA_GMAX] = gMonIcon_DrednawMegaGmax,
    [SPECIES_COALOSSAL_MEGA_GMAX] = gMonIcon_CoalossalMegaGmax,
    [SPECIES_FLAPPLE_MEGA_GMAX] = gMonIcon_FlappleMegaGmax,
    [SPECIES_APPLETUN_MEGA_GMAX] = gMonIcon_AppletunMegaGmax,
    [SPECIES_SANDACONDA_MEGA_GMAX] = gMonIcon_SandacondaMegaGmax,
    [SPECIES_TOXTRICITY_MEGA_GMAX] = gMonIcon_ToxtricityMegaGmax,
    [SPECIES_CENTISKORCH_MEGA_GMAX] = gMonIcon_CentiskorchMegaGmax,
    [SPECIES_HATTERENE_MEGA_GMAX] = gMonIcon_HattereneMegaGmax,
    [SPECIES_GRIMMSNARL_MEGA_GMAX] = gMonIcon_GrimmsnarlMegaGmax,
    [SPECIES_ALCREMIE_MEGA_GMAX] = gMonIcon_AlcremieMegaGmax,
    [SPECIES_COPPERAJAH_MEGA_GMAX] = gMonIcon_CopperajahMegaGmax,
    [SPECIES_DURALUDON_MEGA_GMAX] = gMonIcon_DuraludonMegaGmax,
    [SPECIES_URSHIFU_RAPID_MEGA_GMAX] = gMonIcon_UrshifuRapidMegaGmax,
    [SPECIES_URSHIFU_ONE_MEGA_GMAX] = gMonIcon_UrshifuOneMegaGmax,
#endif
...
const u8 gMonIconPaletteIndices[] =
{
    ...
    [SPECIES_VENUSAUR_MEGA_GMAX] = 0,
    [SPECIES_CHARIZARD_MEGA_GMAX] = 0,
    [SPECIES_BLASTOISE_MEGA_GMAX] = 0,
    [SPECIES_BUTTERFREE_MEGA_GMAX] = 0,
    [SPECIES_PIKACHU_MEGA_GMAX] = 2,
    [SPECIES_MACHAMP_MEGA_GMAX] = 0,
    [SPECIES_GENGAR_MEGA_GMAX] = 2,
    [SPECIES_KINGLER_MEGA_GMAX] = 0,
    [SPECIES_LAPRAS_MEGA_GMAX] = 2,
    [SPECIES_EEVEE_MEGA_GMAX] = 2,
    [SPECIES_SNORLAX_MEGA_GMAX] = 3,
    [SPECIES_GARBODOR_MEGA_GMAX] = 0,
    [SPECIES_MELMETAL_MEGA_GMAX] = 0,
    [SPECIES_RILLABOOM_MEGA_GMAX] = 1,
    [SPECIES_CINDERACE_MEGA_GMAX] = 0,
    [SPECIES_INTELEON_MEGA_GMAX] = 0,
    [SPECIES_CORVIKNIGHT_MEGA_GMAX] = 0,
    [SPECIES_ORBEETLE_MEGA_GMAX] = 0,
    [SPECIES_DREDNAW_MEGA_GMAX] = 0,
    [SPECIES_COALOSSAL_MEGA_GMAX] = 0,
    [SPECIES_FLAPPLE_MEGA_GMAX] = 1,
    [SPECIES_APPLETUN_MEGA_GMAX] = 1,
    [SPECIES_SANDACONDA_MEGA_GMAX] = 1,
    [SPECIES_TOXTRICITY_MEGA_GMAX] = 0,
    [SPECIES_CENTISKORCH_MEGA_GMAX] = 0,
    [SPECIES_HATTERENE_MEGA_GMAX] = 0,
    [SPECIES_GRIMMSNARL_MEGA_GMAX] = 0,
    [SPECIES_ALCREMIE_MEGA_GMAX] = 1,
    [SPECIES_COPPERAJAH_MEGA_GMAX] = 0,
    [SPECIES_DURALUDON_MEGA_GMAX] = 0,
    [SPECIES_URSHIFU_ONE_MEGA_GMAX] = 0,
    [SPECIES_URSHIFU_RAPID_MEGA_GMAX] = 0,
#endif
    [SPECIES_EGG] = 1,
};
