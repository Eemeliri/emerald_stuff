const struct FormChange *const gFormChangeTablePointers[NUM_SPECIES] =
{
    ...
    [SPECIES_VENUSAUR_MEGA_GMAX] = sVenusaurFormChangeTable,
    [SPECIES_CHARIZARD_MEGA_GMAX] = sCharizardFormChangeTable,
    [SPECIES_BLASTOISE_MEGA_GMAX] = sBlastoiseFormChangeTable,
    [SPECIES_BUTTERFREE_MEGA_GMAX] = sButterfreeFormChangeTable,
    [SPECIES_PIKACHU_MEGA_GMAX] = sPikachuFormChangeTable,
    [SPECIES_MACHAMP_MEGA_GMAX] = sMachampFormChangeTable,
    [SPECIES_GENGAR_MEGA_GMAX] = sGengarFormChangeTable,
    [SPECIES_KINGLER_MEGA_GMAX] = sKinglerFormChangeTable,
    [SPECIES_LAPRAS_MEGA_GMAX] = sLaprasFormChangeTable,
    [SPECIES_EEVEE_MEGA_GMAX] = sEeveeFormChangeTable,
    [SPECIES_SNORLAX_MEGA_GMAX] = sSnorlaxFormChangeTable,
    [SPECIES_GARBODOR_MEGA_GMAX] = sGarbodorFormChangeTable,
    [SPECIES_MELMETAL_MEGA_GMAX] = sMelmetalFormChangeTable,
    [SPECIES_RILLABOOM_MEGA_GMAX] = sRillaboomFormChangeTable,
    [SPECIES_CINDERACE_MEGA_GMAX] = sCinderaceFormChangeTable,
    [SPECIES_INTELEON_MEGA_GMAX] = sInteleonFormChangeTable,
    [SPECIES_CORVIKNIGHT_MEGA_GMAX] = sCorviknightFormChangeTable,
    [SPECIES_ORBEETLE_MEGA_GMAX] = sOrbeetleFormChangeTable,
    [SPECIES_DREDNAW_MEGA_GMAX] = sDrednawFormChangeTable,
    [SPECIES_COALOSSAL_MEGA_GMAX] = sCoalossalFormChangeTable,
    [SPECIES_FLAPPLE_MEGA_GMAX] = sFlappleFormChangeTable,
    [SPECIES_APPLETUN_MEGA_GMAX] = sAppletunFormChangeTable,
    [SPECIES_SANDACONDA_MEGA_GMAX] = sSandacondaFormChangeTable,
    [SPECIES_TOXTRICITY_MEGA_GMAX] = sToxtricityFormChangeTable,
    [SPECIES_CENTISKORCH_MEGA_GMAX] = sCentiskorchFormChangeTable,
    [SPECIES_HATTERENE_MEGA_GMAX] = sHattereneFormChangeTable,
    [SPECIES_GRIMMSNARL_MEGA_GMAX] = sGrimsnarlFormChangeTable,
    [SPECIES_ALCREMIE_MEGA_GMAX] = sAlcremieFormChangeTable,
    [SPECIES_COPPERAJAH_MEGA_GMAX] = sCopperajahFormChangeTable,
    [SPECIES_DURALUDON_MEGA_GMAX] = sDuraludonFormChangeTable,
    [SPECIES_URSHIFU_RAPID_MEGA_GMAX] = sUrshifuFormChangeTable,
    [SPECIES_URSHIFU_ONE_MEGA_GMAX] = sUrshifuFormChangeTable,
#endif
