...
static bool8 LoadMonAndSceneGfx(struct Pokemon *mon)
{
    ...
    case 0:
        ...
        HandleLoadSpecialPokePic(&gMonFrontPicTable[species], gMonSpritesGfxPtr->sprites.ptr[B_POSITION_OPPONENT_LEFT], species, personality, GetMonData(mon, MON_DATA_MET_GAME));
