const struct LevelUpMove *const gLevelUpLearnsets[NUM_SPECIES] =
{
    ...
    //Gmax Megas
    [SPECIES_VENUSAUR_MEGA_GMAX] = sVenusaurLevelUpLearnset,
    [SPECIES_CHARIZARD_MEGA_GMAX] = sCharizardLevelUpLearnset,
    [SPECIES_BLASTOISE_MEGA_GMAX] = sBlastoiseLevelUpLearnset,
    [SPECIES_BUTTERFREE_MEGA_GMAX] = sButterfreeLevelUpLearnset,
    [SPECIES_PIKACHU_MEGA_GMAX] = sPikachuLevelUpLearnset,
    [SPECIES_MACHAMP_MEGA_GMAX] = sMachampLevelUpLearnset,
    [SPECIES_GENGAR_MEGA_GMAX] = sGengarLevelUpLearnset,
    [SPECIES_KINGLER_MEGA_GMAX] = sKinglerLevelUpLearnset,
    [SPECIES_LAPRAS_MEGA_GMAX] = sLaprasLevelUpLearnset,
    [SPECIES_EEVEE_MEGA_GMAX] = sEeveeLevelUpLearnset,
    [SPECIES_SNORLAX_MEGA_GMAX] = sSnorlaxLevelUpLearnset,
    [SPECIES_GARBODOR_MEGA_GMAX] = sGarbodorLevelUpLearnset,
    [SPECIES_MELMETAL_MEGA_GMAX] = sMelmetalLevelUpLearnset,
    [SPECIES_RILLABOOM_MEGA_GMAX] = sRillaboomLevelUpLearnset,
    [SPECIES_CINDERACE_MEGA_GMAX] = sCinderaceLevelUpLearnset,
    [SPECIES_INTELEON_MEGA_GMAX] = sInteleonLevelUpLearnset,
    [SPECIES_CORVIKNIGHT_MEGA_GMAX] = sCorviknightLevelUpLearnset,
    [SPECIES_ORBEETLE_MEGA_GMAX] = sOrbeetleLevelUpLearnset,
    [SPECIES_DREDNAW_MEGA_GMAX] = sDrednawLevelUpLearnset,
    [SPECIES_COALOSSAL_MEGA_GMAX] = sCoalossalLevelUpLearnset,
    [SPECIES_FLAPPLE_MEGA_GMAX] = sFlappleLevelUpLearnset,
    [SPECIES_APPLETUN_MEGA_GMAX] = sAppletunLevelUpLearnset,
    [SPECIES_SANDACONDA_MEGA_GMAX] = sSandacondaLevelUpLearnset,
    [SPECIES_TOXTRICITY_MEGA_GMAX] = sToxtricityLevelUpLearnset,
    [SPECIES_CENTISKORCH_MEGA_GMAX] = sCentiskorchLevelUpLearnset,
    [SPECIES_HATTERENE_MEGA_GMAX] = sHattereneLevelUpLearnset,
    [SPECIES_GRIMMSNARL_MEGA_GMAX] = sGrimmsnarlLevelUpLearnset,
    [SPECIES_ALCREMIE_MEGA_GMAX] = sAlcremieLevelUpLearnset,
    [SPECIES_COPPERAJAH_MEGA_GMAX] = sCopperajahLevelUpLearnset,
    [SPECIES_DURALUDON_MEGA_GMAX] = sDuraludonLevelUpLearnset,
    [SPECIES_URSHIFU_RAPID_MEGA_GMAX] = sUrshifuLevelUpLearnset,
    [SPECIES_URSHIFU_ONE_MEGA_GMAX] = sUrshifuLevelUpLearnset,
#endif
};
