...
static const union AnimCmd *const sAnims_G_Admin_Mars[] ={
    sAnim_GeneralFrame0,
};

static const union AnimCmd *const sAnims_G_Admin_Jupiter[] ={
    sAnim_GeneralFrame0,
};
...
static const union AnimCmd *const sAnims_Lawrence[] ={
    sAnim_GeneralFrame0,
};
...
const union AnimCmd *const *const gTrainerFrontAnimsPtrTable[] =
{
    ...
    [TRAINER_PIC_LAWRENCE] = sAnims_Lawrence,
    ...
    [TRAINER_PIC_LEADER_BROCK] = sAnims_RubySapphireMay,
    [TRAINER_PIC_LEADER_MISTY] = sAnims_RubySapphireMay,
    [TRAINER_PIC_LEADER_SURGE] = sAnims_RubySapphireMay,
    [TRAINER_PIC_LEADER_ERIKA] = sAnims_RubySapphireMay,
    [TRAINER_PIC_LEADER_JANINE] = sAnims_RubySapphireMay,
    [TRAINER_PIC_LEADER_SABRINA] = sAnims_RubySapphireMay,
    [TRAINER_PIC_LEADER_BLAINE] = sAnims_RubySapphireMay,
    [TRAINER_PIC_LEADER_GIOVANNI] = sAnims_RubySapphireMay,
    [TRAINER_PIC_LEADER_FALKNER] = sAnims_RubySapphireMay,
    [TRAINER_PIC_LEADER_BUGSY] = sAnims_RubySapphireMay,
    [TRAINER_PIC_LEADER_WHITNEY] = sAnims_RubySapphireMay,
    [TRAINER_PIC_LEADER_MORTY] = sAnims_RubySapphireMay,
    [TRAINER_PIC_LEADER_CHUCK] = sAnims_RubySapphireMay,
    [TRAINER_PIC_LEADER_JASMINE] = sAnims_RubySapphireMay,
    [TRAINER_PIC_LEADER_PRYCE] = sAnims_RubySapphireMay,
    [TRAINER_PIC_LEADER_CLAIR] = sAnims_RubySapphireMay,
    [TRAINER_PIC_LEADER_TATE] = sAnims_RubySapphireMay,
    [TRAINER_PIC_LEADER_LIZA] = sAnims_RubySapphireMay,
};
