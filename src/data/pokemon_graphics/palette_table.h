...
#endif
    SPECIES_PAL(VENUSAUR_MEGA_GMAX, gMonPalette_VenusaurMegaGmax),
    SPECIES_PAL(CHARIZARD_MEGA_GMAX, gMonPalette_CharizardMegaGmax),
    SPECIES_PAL(BLASTOISE_MEGA_GMAX, gMonPalette_BlastoiseMegaGmax),
    SPECIES_PAL(BUTTERFREE_MEGA_GMAX, gMonPalette_ButterfreeMegaGmax),
    SPECIES_PAL(PIKACHU_MEGA_GMAX, gMonPalette_PikachuMegaGmax),
    SPECIES_PAL(MACHAMP_MEGA_GMAX, gMonPalette_MachampMegaGmax),
    SPECIES_PAL(GENGAR_MEGA_GMAX, gMonPalette_GengarMegaGmax),
    SPECIES_PAL(KINGLER_MEGA_GMAX, gMonPalette_KinglerMegaGmax),
    SPECIES_PAL(LAPRAS_MEGA_GMAX, gMonPalette_LaprasMegaGmax),
    SPECIES_PAL(EEVEE_MEGA_GMAX, gMonPalette_EeveeMegaGmax),
    SPECIES_PAL(SNORLAX_MEGA_GMAX, gMonPalette_SnorlaxMegaGmax),
    SPECIES_PAL(GARBODOR_MEGA_GMAX, gMonPalette_GarbodorMegaGmax),
    SPECIES_PAL(MELMETAL_MEGA_GMAX, gMonPalette_MelmetalMegaGmax),
    SPECIES_PAL(RILLABOOM_MEGA_GMAX, gMonPalette_RillaboomMegaGmax),
    SPECIES_PAL(CINDERACE_MEGA_GMAX, gMonPalette_CinderaceMegaGmax),
    SPECIES_PAL(INTELEON_MEGA_GMAX, gMonPalette_InteleonMegaGmax),
    SPECIES_PAL(CORVIKNIGHT_MEGA_GMAX, gMonPalette_CorviknightMegaGmax),
    SPECIES_PAL(ORBEETLE_MEGA_GMAX, gMonPalette_OrbeetleMegaGmax),
    SPECIES_PAL(DREDNAW_MEGA_GMAX, gMonPalette_DrednawMegaGmax),
    SPECIES_PAL(COALOSSAL_MEGA_GMAX, gMonPalette_CoalossalMegaGmax),
    SPECIES_PAL(FLAPPLE_MEGA_GMAX, gMonPalette_FlappleMegaGmax),
    SPECIES_PAL(APPLETUN_MEGA_GMAX, gMonPalette_AppletunMegaGmax),
    SPECIES_PAL(SANDACONDA_MEGA_GMAX, gMonPalette_SandacondaMegaGmax),
    SPECIES_PAL(TOXTRICITY_MEGA_GMAX, gMonPalette_ToxtricityMegaGmax),
    SPECIES_PAL(CENTISKORCH_MEGA_GMAX, gMonPalette_CentiskorchMegaGmax),
    SPECIES_PAL(HATTERENE_MEGA_GMAX, gMonPalette_HattereneMegaGmax),
    SPECIES_PAL(GRIMMSNARL_MEGA_GMAX, gMonPalette_GrimmsnarlMegaGmax),
    SPECIES_PAL(ALCREMIE_MEGA_GMAX, gMonPalette_AlcremieMegaGmax),
    SPECIES_PAL(COPPERAJAH_MEGA_GMAX, gMonPalette_CopperajahMegaGmax),
    SPECIES_PAL(DURALUDON_MEGA_GMAX, gMonPalette_DuraludonMegaGmax),
    SPECIES_PAL(URSHIFU_RAPID_MEGA_GMAX, gMonPalette_UrshifuRapidMegaGmax),
    SPECIES_PAL(URSHIFU_ONE_MEGA_GMAX, gMonPalette_UrshifuOneMegaGmax), 
