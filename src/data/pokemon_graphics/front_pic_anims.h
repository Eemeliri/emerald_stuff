...
static const union AnimCmd sAnim_VENUSAUR_MEGA_GMAX_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};

static const union AnimCmd sAnim_CHARIZARD_MEGA_GMAX_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};

static const union AnimCmd sAnim_BLASTOISE_MEGA_GMAX_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};

static const union AnimCmd sAnim_BUTTERFREE_MEGA_GMAX_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};

static const union AnimCmd sAnim_PIKACHU_MEGA_GMAX_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};

static const union AnimCmd sAnim_MACHAMP_MEGA_GMAX_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};

static const union AnimCmd sAnim_GENGAR_MEGA_GMAX_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};

static const union AnimCmd sAnim_KINGLER_MEGA_GMAX_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};

static const union AnimCmd sAnim_LAPRAS_MEGA_GMAX_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};

static const union AnimCmd sAnim_EEVEE_MEGA_GMAX_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};

static const union AnimCmd sAnim_SNORLAX_MEGA_GMAX_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};
static const union AnimCmd sAnim_GARBODOR_MEGA_GMAX_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};
static const union AnimCmd sAnim_MELMETAL_MEGA_GMAX_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};
static const union AnimCmd sAnim_RILLABOOM_MEGA_GMAX_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};

static const union AnimCmd sAnim_CINDERACE_MEGA_GMAX_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};

static const union AnimCmd sAnim_INTELEON_MEGA_GMAX_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};

static const union AnimCmd sAnim_CORVIKNIGHT_MEGA_GMAX_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};

static const union AnimCmd sAnim_ORBEETLE_MEGA_GMAX_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};

static const union AnimCmd sAnim_DREDNAW_MEGA_GMAX_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};

static const union AnimCmd sAnim_COALOSSAL_MEGA_GMAX_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};

static const union AnimCmd sAnim_FLAPPLE_MEGA_GMAX_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};

static const union AnimCmd sAnim_APPLETUN_MEGA_GMAX_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};

static const union AnimCmd sAnim_SANDACONDA_MEGA_GMAX_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};

static const union AnimCmd sAnim_TOXTRICITY_MEGA_GMAX_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};

static const union AnimCmd sAnim_CENTISKORCH_MEGA_GMAX_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};

static const union AnimCmd sAnim_HATTERENE_MEGA_GMAX_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};

static const union AnimCmd sAnim_GRIMMSNARL_MEGA_GMAX_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};

static const union AnimCmd sAnim_ALCREMIE_MEGA_GMAX_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};

static const union AnimCmd sAnim_COPPERAJAH_MEGA_GMAX_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};

static const union AnimCmd sAnim_DURALUDON_MEGA_GMAX_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};

static const union AnimCmd sAnim_URSHIFU_ONE_MEGA_GMAX_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};

static const union AnimCmd sAnim_URSHIFU_RAPID_MEGA_GMAX_1[] =
{
    ANIMCMD_FRAME(0, 1),
    ANIMCMD_END,
};
...
#endif
// Gigantamax Forms
SINGLE_ANIMATION(VENUSAUR_MEGA_GMAX);
SINGLE_ANIMATION(CHARIZARD_MEGA_GMAX);
SINGLE_ANIMATION(BLASTOISE_MEGA_GMAX);
SINGLE_ANIMATION(BUTTERFREE_MEGA_GMAX);
SINGLE_ANIMATION(PIKACHU_MEGA_GMAX);
SINGLE_ANIMATION(MACHAMP_MEGA_GMAX);
SINGLE_ANIMATION(GENGAR_MEGA_GMAX);
SINGLE_ANIMATION(KINGLER_MEGA_GMAX);
SINGLE_ANIMATION(LAPRAS_MEGA_GMAX);
SINGLE_ANIMATION(EEVEE_MEGA_GMAX);
SINGLE_ANIMATION(SNORLAX_MEGA_GMAX);
#if P_GEN_5_POKEMON == TRUE
SINGLE_ANIMATION(GARBODOR_MEGA_GMAX);
#endif
#if P_GEN_7_POKEMON == TRUE
SINGLE_ANIMATION(MELMETAL_MEGA_GMAX);
#endif
#if P_GEN_8_POKEMON == TRUE
SINGLE_ANIMATION(RILLABOOM_MEGA_GMAX);
SINGLE_ANIMATION(CINDERACE_MEGA_GMAX);
SINGLE_ANIMATION(INTELEON_MEGA_GMAX);
SINGLE_ANIMATION(CORVIKNIGHT_MEGA_GMAX);
SINGLE_ANIMATION(ORBEETLE_MEGA_GMAX);
SINGLE_ANIMATION(DREDNAW_MEGA_GMAX);
SINGLE_ANIMATION(COALOSSAL_MEGA_GMAX);
SINGLE_ANIMATION(FLAPPLE_MEGA_GMAX);
SINGLE_ANIMATION(APPLETUN_MEGA_GMAX);
SINGLE_ANIMATION(SANDACONDA_MEGA_GMAX);
SINGLE_ANIMATION(TOXTRICITY_MEGA_GMAX);
SINGLE_ANIMATION(CENTISKORCH_MEGA_GMAX);
SINGLE_ANIMATION(HATTERENE_MEGA_GMAX);
SINGLE_ANIMATION(GRIMMSNARL_MEGA_GMAX);
SINGLE_ANIMATION(ALCREMIE_MEGA_GMAX);
SINGLE_ANIMATION(COPPERAJAH_MEGA_GMAX);
SINGLE_ANIMATION(DURALUDON_MEGA_GMAX);
SINGLE_ANIMATION(URSHIFU_ONE_MEGA_GMAX);
SINGLE_ANIMATION(URSHIFU_RAPID_MEGA_GMAX);
#endif
...
#endif
    [SPECIES_VENUSAUR_MEGA_GMAX] = sAnims_VENUSAUR_MEGA_GMAX,
    [SPECIES_CHARIZARD_MEGA_GMAX] = sAnims_CHARIZARD_MEGA_GMAX,
    [SPECIES_BLASTOISE_MEGA_GMAX] = sAnims_BLASTOISE_MEGA_GMAX,
    [SPECIES_BUTTERFREE_MEGA_GMAX] = sAnims_BUTTERFREE_MEGA_GMAX,
    [SPECIES_PIKACHU_MEGA_GMAX] = sAnims_PIKACHU_MEGA_GMAX,
    [SPECIES_MACHAMP_MEGA_GMAX] = sAnims_MACHAMP_MEGA_GMAX,
    [SPECIES_GENGAR_MEGA_GMAX] = sAnims_GENGAR_MEGA_GMAX,
    [SPECIES_KINGLER_MEGA_GMAX] = sAnims_KINGLER_MEGA_GMAX,
    [SPECIES_LAPRAS_MEGA_GMAX] = sAnims_LAPRAS_MEGA_GMAX,
    [SPECIES_EEVEE_MEGA_GMAX] = sAnims_EEVEE_MEGA_GMAX,
    [SPECIES_SNORLAX_MEGA_GMAX] = sAnims_SNORLAX_MEGA_GMAX,
    [SPECIES_GARBODOR_MEGA_GMAX] = sAnims_GARBODOR_MEGA_GMAX,
    [SPECIES_MELMETAL_MEGA_GMAX] = sAnims_MELMETAL_MEGA_GMAX,
    [SPECIES_RILLABOOM_MEGA_GMAX] = sAnims_RILLABOOM_MEGA_GMAX,
    [SPECIES_CINDERACE_MEGA_GMAX] = sAnims_CINDERACE_MEGA_GMAX,
    [SPECIES_INTELEON_MEGA_GMAX] = sAnims_INTELEON_MEGA_GMAX,
    [SPECIES_CORVIKNIGHT_MEGA_GMAX] = sAnims_CORVIKNIGHT_MEGA_GMAX,
    [SPECIES_ORBEETLE_MEGA_GMAX] = sAnims_ORBEETLE_MEGA_GMAX,
    [SPECIES_DREDNAW_MEGA_GMAX] = sAnims_DREDNAW_MEGA_GMAX,
    [SPECIES_COALOSSAL_MEGA_GMAX] = sAnims_COALOSSAL_MEGA_GMAX,
    [SPECIES_FLAPPLE_MEGA_GMAX] = sAnims_FLAPPLE_MEGA_GMAX,
    [SPECIES_APPLETUN_MEGA_GMAX] = sAnims_APPLETUN_MEGA_GMAX,
    [SPECIES_SANDACONDA_MEGA_GMAX] = sAnims_SANDACONDA_MEGA_GMAX,
    [SPECIES_TOXTRICITY_MEGA_GMAX] = sAnims_TOXTRICITY_MEGA_GMAX,
    [SPECIES_CENTISKORCH_MEGA_GMAX] = sAnims_CENTISKORCH_MEGA_GMAX,
    [SPECIES_HATTERENE_MEGA_GMAX] = sAnims_HATTERENE_MEGA_GMAX,
    [SPECIES_GRIMMSNARL_MEGA_GMAX] = sAnims_GRIMMSNARL_MEGA_GMAX,
    [SPECIES_ALCREMIE_MEGA_GMAX] = sAnims_ALCREMIE_MEGA_GMAX,
    [SPECIES_COPPERAJAH_MEGA_GMAX] = sAnims_COPPERAJAH_MEGA_GMAX,
    [SPECIES_DURALUDON_MEGA_GMAX] = sAnims_DURALUDON_MEGA_GMAX,
    [SPECIES_URSHIFU_ONE_MEGA_GMAX] = sAnims_URSHIFU_ONE_MEGA_GMAX,
    [SPECIES_URSHIFU_RAPID_MEGA_GMAX] = sAnims_URSHIFU_RAPID_MEGA_GMAX,
