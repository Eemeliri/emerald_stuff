...
#define MB_POKEMON_CENTER_SIGN 0x23
...
#define MB_UP_RIGHT_STAIR_WARP 0xF0
#define MB_UP_LEFT_STAIR_WARP 0xF1
#define MB_DOWN_RIGHT_STAIR_WARP 0xF2
#define MB_DOWN_LEFT_STAIR_WARP 0xF3
#define MB_UNUSED_F4 0xF4
