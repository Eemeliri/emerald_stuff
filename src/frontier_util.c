...
static const struct FrontierBrainMon sFrontierGymLeaderMons[][6] =
{
    ...
    {
        {
            ...
            .nature = NATURE_MODEST,
            .evs = {0, 0, 0, 252, 252, 0},
            .moves = {MOVE_PSYSHOCK, MOVE_SHADOW_BALL, MOVE_FOCUS_BLAST, MOVE_CHARGE},
        },
        {
    ...
    [TRAINER_FRONTIER_MORTY] =
    {
        ...
        },
        {
            ...
            .nature = NATURE_ADAMANT,
            .evs = {252, 252, 0, 0, 0, 0},
            .moves = {MOVE_SHADOW_BALL, MOVE_SUCKER_PUNCH, MOVE_CURSE, MOVE_WILL_O_WISP},
        },
        {
    ...
    [TRAINER_FRONTIER_PRYCE] =
    {
        ...
        },
        {
            ...
            .nature = NATURE_MODEST,
            .evs = {0, 252, 0, 252, 0, 0},
            .moves = {MOVE_ICICLE_CRASH, MOVE_RAZOR_SHELL, MOVE_ROCK_BLAST, MOVE_SHELL_SMASH},
        },
        {
            .species = SPECIES_LAPRAS,
            .heldItem = ITEM_PETAYA_BERRY,
    ...
    {
        {
            ...
            .nature = NATURE_MODEST,
            .evs = {0, 252, 0, 252, 0, 4},
            .moves = {MOVE_DRAGON_RUSH, MOVE_HURRICANE, MOVE_YAWN, MOVE_AGILITY},
        },
        {
    ...
    [TRAINER_FRONTIER_WAKE] =
    {
        ...
        },
        {
            ...
            .nature = NATURE_MODEST,
            .evs = {252, 0, 0, 0, 252, 0},
            .moves = {MOVE_MUDDY_WATER, MOVE_EARTH_POWER, MOVE_RAIN_DANCE, MOVE_CURSE},
        },
        {
    ...
    [TRAINER_FRONTIER_CILAN] =
    {
        ...
        },
        {
            ...
            .nature = NATURE_MODEST,
            .evs = {252, 0, 252, 0, 0, 0},
            .moves = {MOVE_LEECH_SEED, MOVE_COTTON_SPORE, MOVE_SLEEP_POWDER, MOVE_GIGA_DRAIN},
        },
        {
...
static const u8 sFrontierLeaderObjEventGfx[] =
{
    [TRAINER_FRONTIER_BROCK]   = OBJ_EVENT_GFX_ROXANNE,
    [TRAINER_FRONTIER_MISTY]    = OBJ_EVENT_GFX_BRAWLY,
    [TRAINER_FRONTIER_SURGE]  = OBJ_EVENT_GFX_WATTSON,
    [TRAINER_FRONTIER_ERIKA]   = OBJ_EVENT_GFX_FLANNERY,
    [TRAINER_FRONTIER_JANINE] = OBJ_EVENT_GFX_NORMAN,
    [TRAINER_FRONTIER_SABRINA]    = OBJ_EVENT_GFX_WINONA,
    [TRAINER_FRONTIER_BLAINE] = OBJ_EVENT_GFX_TATE,
    [TRAINER_FRONTIER_GIOVANNI] = OBJ_EVENT_GFX_LIZA,

    [TRAINER_FRONTIER_FALKNER]   = OBJ_EVENT_GFX_ROXANNE,
    [TRAINER_FRONTIER_BUGSY]    = OBJ_EVENT_GFX_BRAWLY,
    [TRAINER_FRONTIER_WHITNEY]  = OBJ_EVENT_GFX_WATTSON,
    [TRAINER_FRONTIER_MORTY]   = OBJ_EVENT_GFX_FLANNERY,
    [TRAINER_FRONTIER_CHUCK] = OBJ_EVENT_GFX_NORMAN,
    [TRAINER_FRONTIER_JASMINE]    = OBJ_EVENT_GFX_WINONA,
    [TRAINER_FRONTIER_PRYCE] = OBJ_EVENT_GFX_TATE,
    [TRAINER_FRONTIER_CLAIR] = OBJ_EVENT_GFX_LIZA,
