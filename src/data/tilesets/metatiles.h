...
const u16 gMetatiles_Saturated_Tileset[] = INCBIN_U16("data/tilesets/primary/saturated_tileset/metatiles.bin");
const u16 gMetatileAttributes_Saturated_Tileset[] = INCBIN_U16("data/tilesets/primary/saturated_tileset/metatile_attributes.bin");
