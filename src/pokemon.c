...
//Hisuian Forms
    ...
    [SPECIES_VENUSAUR_MEGA_GMAX - 1] = NATIONAL_DEX_VENUSAUR,
    [SPECIES_CHARIZARD_MEGA_GMAX - 1] = NATIONAL_DEX_CHARIZARD,
    [SPECIES_BLASTOISE_MEGA_GMAX - 1] = NATIONAL_DEX_BLASTOISE,
    [SPECIES_BUTTERFREE_MEGA_GMAX - 1] = NATIONAL_DEX_BUTTERFREE,
    [SPECIES_PIKACHU_MEGA_GMAX - 1] = NATIONAL_DEX_PIKACHU,
    [SPECIES_MACHAMP_MEGA_GMAX - 1] = NATIONAL_DEX_MACHAMP,
    [SPECIES_GENGAR_MEGA_GMAX - 1] = NATIONAL_DEX_GENGAR,
    [SPECIES_KINGLER_MEGA_GMAX - 1] = NATIONAL_DEX_KINGLER,
    [SPECIES_LAPRAS_MEGA_GMAX - 1] = NATIONAL_DEX_LAPRAS,
    [SPECIES_EEVEE_MEGA_GMAX - 1] = NATIONAL_DEX_EEVEE,
    [SPECIES_SNORLAX_MEGA_GMAX - 1] = NATIONAL_DEX_SNORLAX,
    [SPECIES_GARBODOR_MEGA_GMAX - 1] = NATIONAL_DEX_GARBODOR,
    [SPECIES_MELMETAL_MEGA_GMAX - 1] = NATIONAL_DEX_MELMETAL,
    [SPECIES_RILLABOOM_MEGA_GMAX - 1] = NATIONAL_DEX_RILLABOOM,
    [SPECIES_CINDERACE_MEGA_GMAX - 1] = NATIONAL_DEX_CINDERACE,
    [SPECIES_INTELEON_MEGA_GMAX - 1] = NATIONAL_DEX_INTELEON,
    [SPECIES_CORVIKNIGHT_MEGA_GMAX - 1] = NATIONAL_DEX_CORVIKNIGHT,
    [SPECIES_ORBEETLE_MEGA_GMAX - 1] = NATIONAL_DEX_ORBEETLE,
    [SPECIES_DREDNAW_MEGA_GMAX - 1] = NATIONAL_DEX_DREDNAW,
    [SPECIES_COALOSSAL_MEGA_GMAX - 1] = NATIONAL_DEX_COALOSSAL,
    [SPECIES_FLAPPLE_MEGA_GMAX - 1] = NATIONAL_DEX_FLAPPLE,
    [SPECIES_APPLETUN_MEGA_GMAX - 1] = NATIONAL_DEX_APPLETUN,
    [SPECIES_SANDACONDA_MEGA_GMAX - 1] = NATIONAL_DEX_SANDACONDA,
    [SPECIES_TOXTRICITY_MEGA_GMAX - 1] = NATIONAL_DEX_TOXTRICITY,
    [SPECIES_CENTISKORCH_MEGA_GMAX - 1] = NATIONAL_DEX_CENTISKORCH,
    [SPECIES_HATTERENE_MEGA_GMAX - 1] = NATIONAL_DEX_HATTERENE,
    [SPECIES_GRIMMSNARL_MEGA_GMAX - 1] = NATIONAL_DEX_GRIMMSNARL,
    [SPECIES_ALCREMIE_MEGA_GMAX - 1] = NATIONAL_DEX_ALCREMIE,
    [SPECIES_COPPERAJAH_MEGA_GMAX - 1] = NATIONAL_DEX_COPPERAJAH,
    [SPECIES_DURALUDON_MEGA_GMAX - 1] = NATIONAL_DEX_DURALUDON,
    [SPECIES_URSHIFU_RAPID_MEGA_GMAX - 1] = NATIONAL_DEX_URSHIFU,
    [SPECIES_URSHIFU_ONE_MEGA_GMAX - 1] = NATIONAL_DEX_URSHIFU,
#endif
};
