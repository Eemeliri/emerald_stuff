const u16 *const gFormSpeciesIdTables[NUM_SPECIES] =
{
    ...
    // Gmax megas
    [SPECIES_VENUSAUR_MEGA_GMAX] = sVenusaurFormSpeciesIdTable,
    [SPECIES_CHARIZARD_MEGA_GMAX] = sCharizardFormSpeciesIdTable,
    [SPECIES_BLASTOISE_MEGA_GMAX] = sBlastoiseFormSpeciesIdTable,
    [SPECIES_BUTTERFREE_MEGA_GMAX] = sButterfreeFormSpeciesIdTable,
    [SPECIES_PIKACHU_MEGA_GMAX] = sPikachuFormSpeciesIdTable,
    [SPECIES_MACHAMP_MEGA_GMAX] = sMachampFormSpeciesIdTable,
    [SPECIES_GENGAR_MEGA_GMAX] = sGengarFormSpeciesIdTable,
    [SPECIES_KINGLER_MEGA_GMAX] = sKinglerFormSpeciesIdTable,
    [SPECIES_LAPRAS_MEGA_GMAX] = sLaprasFormSpeciesIdTable,
    [SPECIES_EEVEE_MEGA_GMAX] = sEeveeFormSpeciesIdTable,
    [SPECIES_SNORLAX_MEGA_GMAX] = sSnorlaxFormSpeciesIdTable,
    [SPECIES_GARBODOR_MEGA_GMAX] = sGarbodorFormSpeciesIdTable,
    [SPECIES_MELMETAL_MEGA_GMAX] = sMelmetalFormSpeciesIdTable,
    [SPECIES_RILLABOOM_MEGA_GMAX] = sRillaboomFormSpeciesIdTable,
    [SPECIES_CINDERACE_MEGA_GMAX] = sCinderaceFormSpeciesIdTable,
    [SPECIES_INTELEON_MEGA_GMAX] = sInteleonFormSpeciesIdTable,
    [SPECIES_CORVIKNIGHT_MEGA_GMAX] = sCorviknightFormSpeciesIdTable,
    [SPECIES_ORBEETLE_MEGA_GMAX] = sOrbeetleFormSpeciesIdTable,
    [SPECIES_DREDNAW_MEGA_GMAX] = sDrednawFormSpeciesIdTable,
    [SPECIES_COALOSSAL_MEGA_GMAX] = sCoalossalFormSpeciesIdTable,
    [SPECIES_FLAPPLE_MEGA_GMAX] = sFlappleFormSpeciesIdTable,
    [SPECIES_APPLETUN_MEGA_GMAX] = sAppletunFormSpeciesIdTable,
    [SPECIES_SANDACONDA_MEGA_GMAX] = sSandacondaFormSpeciesIdTable,
    [SPECIES_TOXTRICITY_MEGA_GMAX] = sToxtricityFormSpeciesIdTable,
    [SPECIES_CENTISKORCH_MEGA_GMAX] = sCentiskorchFormSpeciesIdTable,
    [SPECIES_HATTERENE_MEGA_GMAX] = sHattereneFormSpeciesIdTable,
    [SPECIES_GRIMMSNARL_MEGA_GMAX] = sGrimsnarlFormSpeciesIdTable,
    [SPECIES_ALCREMIE_MEGA_GMAX] = sAlcremieFormSpeciesIdTable,
    [SPECIES_COPPERAJAH_MEGA_GMAX] = sCopperajahFormSpeciesIdTable,
    [SPECIES_DURALUDON_MEGA_GMAX] = sDuraludonFormSpeciesIdTable,
    [SPECIES_URSHIFU_RAPID_MEGA_GMAX] = sUrshifuFormSpeciesIdTable,
    [SPECIES_URSHIFU_ONE_MEGA_GMAX] = sUrshifuFormSpeciesIdTable,
#endif
};
