...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(GGRUNT_F, GalacticGruntF, 0, 0, 0x200),
    TRAINER_SPRITE(GGRUNT_M, GalacticGruntM, 0, 0, 0x200),
    TRAINER_SPRITE(G_ADMIN_SATURN, GalacticAdminSaturn, 0, 0, 0x200),
    TRAINER_SPRITE(G_ADMIN_MARS, GalacticAdminMars, 0, 0, 0x200),
    TRAINER_SPRITE(G_ADMIN_JUPITER, GalacticAdminJupiter, 0, 0, 0x200),
    TRAINER_SPRITE(GHOST, Ghost, 0, 0, 0x200),
    TRAINER_SPRITE(LAWRENCE, Lawrence, 0, 0, 0x200),
    TRAINER_SPRITE(CHAMPION_ALDER, Alder, 0, 0, 0x200),
    TRAINER_SPRITE(LEADER_BROCK, Brock, 0, 0, 0x200),
    TRAINER_SPRITE(LEADER_MISTY, Misty, 0, 0, 0x200),
    TRAINER_SPRITE(LEADER_SURGE, Surge, 0, 0, 0x200),
    TRAINER_SPRITE(LEADER_ERIKA, Erika, 0, 0, 0x200),
    TRAINER_SPRITE(LEADER_JANINE, Janine, 0, 0, 0x200),
    TRAINER_SPRITE(LEADER_SABRINA, Sabrina, 0, 0, 0x200),
    TRAINER_SPRITE(LEADER_BLAINE, Blaine, 0, 0, 0x200),
    TRAINER_SPRITE(LEADER_GIOVANNI, Giovanni, 0, 0, 0x200),
    TRAINER_SPRITE(LEADER_FALKNER, Falkner, 0, 0, 0x200),
    TRAINER_SPRITE(LEADER_BUGSY, Bugsy, 0, 0, 0x200),
    TRAINER_SPRITE(LEADER_WHITNEY, Whitney, 0, 0, 0x200),
    TRAINER_SPRITE(LEADER_MORTY, Morty, 0, 0, 0x200),
    TRAINER_SPRITE(LEADER_CHUCK, Chuck, 0, 0, 0x200),
    TRAINER_SPRITE(LEADER_JASMINE, Jasmine, 0, 0, 0x200),
    TRAINER_SPRITE(LEADER_PRYCE, Pryce, 0, 0, 0x200),
    TRAINER_SPRITE(LEADER_CLAIR, Clair, 0, 0, 0x200),
    TRAINER_SPRITE(LEADER_TATE, Tate, 0, 0, 0x200),
    TRAINER_SPRITE(LEADER_LIZA, Liza, 0, 0, 0x200),
    TRAINER_SPRITE(LEADER_ROARK, Roark, 0, 0, 0x200),
    TRAINER_SPRITE(LEADER_GARDENIA, Gardenia, 0, 0, 0x200),
    TRAINER_SPRITE(LEADER_MAYLENE, Maylene, 0, 0, 0x200),
    TRAINER_SPRITE(LEADER_WAKE, Wake, 0, 0, 0x200),
    TRAINER_SPRITE(LEADER_FANTINA, Fantina, 0, 0, 0x200),
    TRAINER_SPRITE(LEADER_BYRON, Byron, 0, 0, 0x200),
    TRAINER_SPRITE(LEADER_CANDICE, Candice, 0, 0, 0x200),
    TRAINER_SPRITE(LEADER_VOLKNER, Volkner, 0, 0, 0x200),
    TRAINER_SPRITE(LEADER_CILAN, Cilan, 0, 0, 0x200),
    TRAINER_SPRITE(LEADER_CHILI, Chili, 0, 0, 0x200),
    TRAINER_SPRITE(LEADER_CRESS, Cress, 0, 0, 0x200),
    TRAINER_SPRITE(LEADER_LENORA, Lenora, 0, 0, 0x200),
    TRAINER_SPRITE(LEADER_BURGH, Burgh, 0, 0, 0x200),
    TRAINER_SPRITE(LEADER_ELESA, Elesa, 0, 0, 0x200),
    TRAINER_SPRITE(LEADER_CLAY, Clay, 0, 0, 0x200),
    TRAINER_SPRITE(LEADER_SKYLA, Skyla, 0, 0, 0x200),
    TRAINER_SPRITE(LEADER_BRYCEN, Brycen, 0, 0, 0x200),
    TRAINER_SPRITE(LEADER_DRAYDEN, Drayden, 0, 0, 0x200),
    TRAINER_SPRITE(LEADER_CHEREN, Cheren, 0, 0, 0x200),
    TRAINER_SPRITE(LEADER_ROXIE, Roxie, 0, 0, 0x200),
    TRAINER_SPRITE(LEADER_MARLON, Marlon, 0, 0, 0x200),
    TRAINER_SPRITE(CHAMPION_BLUE, Blue, 0, 0, 0x200),
    TRAINER_SPRITE(CHAMPION_LANCE, Lance, 0, 0, 0x200),
    TRAINER_SPRITE(CYNTHIA, Cynthia, 0, 7, 0x188),
    TRAINER_SPRITE(CHAMPION_IRIS, Iris, 0, 0, 0x200),    
};
