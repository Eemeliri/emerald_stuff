...
//names
const u8 gText_SideQuestName_1[] = _("The Legends Quest");
...
//descriptions
const u8 gText_SideQuestDesc_1[] = _("Scour Hoenn for legendary Pokémon!");
...
const u8 gText_SideQuestDoneDesc_1[] = _("You have caught all the legendaries \nin Hoenn.");
