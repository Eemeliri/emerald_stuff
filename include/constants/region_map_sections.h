...
#define MAPSEC_MIRAGE_SPOT_PLAIN_A          0xDA
#define MAPSEC_MIRAGE_SPOT_PLAIN_B          0xDB
#define MAPSEC_MIRAGE_SPOT_WOODS_A          0xDC
#define MAPSEC_MIRAGE_SPOT_WOODS_B          0xDD
#define MAPSEC_MIRAGE_SPOT_ASH_A            0xDE
#define MAPSEC_MIRAGE_SPOT_ASH_B            0xDF
#define MAPSEC_MIRAGE_SPOT_DESERT_A         0xE0
#define MAPSEC_MIRAGE_SPOT_DESERT_B         0xE1
#define MAPSEC_MIRAGE_SPOT_TALLGRASS_A      0xE2
#define MAPSEC_MIRAGE_SPOT_TALLGRASS_B      0xE3
#define MAPSEC_MIRAGE_SPOT_ISLAND_A         0xE4
#define MAPSEC_MIRAGE_SPOT_ISLAND_B         0xE5
#define MAPSEC_MIRAGE_SPOT_BEACH_A          0xE6
#define MAPSEC_MIRAGE_SPOT_BEACH_B          0xE7
#define MAPSEC_MIRAGE_SPOT_CAVE_A           0xE8
#define MAPSEC_MIRAGE_SPOT_CAVE_B           0xE9
#define MAPSEC_MIRAGE_SPOT_SNOW_A           0xEA
#define MAPSEC_MIRAGE_SPOT_SNOW_B           0xEB
