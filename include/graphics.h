...
extern const u32 gFollowMonPalette_VenusaurMegaGmax[];
extern const u32 gFollowMonPalette_CharizardMegaGmax[];
extern const u32 gFollowMonPalette_BlastoiseMegaGmax[];
extern const u32 gFollowMonPalette_ButterfreeMegaGmax[];
extern const u32 gFollowMonPalette_PikachuMegaGmax[];
extern const u32 gFollowMonPalette_MachampMegaGmax[];
extern const u32 gFollowMonPalette_GengarMegaGmax[];
extern const u32 gFollowMonPalette_KinglerMegaGmax[];
extern const u32 gFollowMonPalette_LaprasMegaGmax[];
extern const u32 gFollowMonPalette_EeveeMegaGmax[];
extern const u32 gFollowMonPalette_SnorlaxMegaGmax[];
extern const u32 gFollowMonPalette_GarbodorMegaGmax[];
extern const u32 gFollowMonPalette_MelmetalMegaGmax[];
extern const u32 gFollowMonPalette_RillaboomMegaGmax[];
extern const u32 gFollowMonPalette_CinderaceMegaGmax[];
extern const u32 gFollowMonPalette_InteleonMegaGmax[];
extern const u32 gFollowMonPalette_CorviknightMegaGmax[];
extern const u32 gFollowMonPalette_OrbeetleMegaGmax[];
extern const u32 gFollowMonPalette_DrednawMegaGmax[];
extern const u32 gFollowMonPalette_CoalossalMegaGmax[];
extern const u32 gFollowMonPalette_FlappleMegaGmax[];
extern const u32 gFollowMonPalette_AppletunMegaGmax[];
extern const u32 gFollowMonPalette_SandacondaMegaGmax[];
extern const u32 gFollowMonPalette_ToxtricityMegaGmax[];
extern const u32 gFollowMonPalette_CentiskorchMegaGmax[];
extern const u32 gFollowMonPalette_HattereneMegaGmax[];
extern const u32 gFollowMonPalette_GrimmsnarlMegaGmax[];
extern const u32 gFollowMonPalette_AlcremieMegaGmax[];
extern const u32 gFollowMonPalette_CopperajahMegaGmax[];
extern const u32 gFollowMonPalette_DuraludonMegaGmax[];
extern const u32 gFollowMonPalette_UrshifuOneMegaGmax[];
extern const u32 gFollowMonPalette_UrshifuRapidMegaGmax[];
...
extern const u32 gFollowMonShinyPalette_VenusaurMegaGmax[];
extern const u32 gFollowMonShinyPalette_CharizardMegaGmax[];
extern const u32 gFollowMonShinyPalette_BlastoiseMegaGmax[];
extern const u32 gFollowMonShinyPalette_ButterfreeMegaGmax[];
extern const u32 gFollowMonShinyPalette_PikachuMegaGmax[];
extern const u32 gFollowMonShinyPalette_MachampMegaGmax[];
extern const u32 gFollowMonShinyPalette_GengarMegaGmax[];
extern const u32 gFollowMonShinyPalette_KinglerMegaGmax[];
extern const u32 gFollowMonShinyPalette_LaprasMegaGmax[];
extern const u32 gFollowMonShinyPalette_EeveeMegaGmax[];
extern const u32 gFollowMonShinyPalette_SnorlaxMegaGmax[];
extern const u32 gFollowMonShinyPalette_GarbodorMegaGmax[];
extern const u32 gFollowMonShinyPalette_MelmetalMegaGmax[];
extern const u32 gFollowMonShinyPalette_RillaboomMegaGmax[];
extern const u32 gFollowMonShinyPalette_CinderaceMegaGmax[];
extern const u32 gFollowMonShinyPalette_InteleonMegaGmax[];
extern const u32 gFollowMonShinyPalette_CorviknightMegaGmax[];
extern const u32 gFollowMonShinyPalette_OrbeetleMegaGmax[];
extern const u32 gFollowMonShinyPalette_DrednawMegaGmax[];
extern const u32 gFollowMonShinyPalette_CoalossalMegaGmax[];
extern const u32 gFollowMonShinyPalette_FlappleMegaGmax[];
extern const u32 gFollowMonShinyPalette_AppletunMegaGmax[];
extern const u32 gFollowMonShinyPalette_SandacondaMegaGmax[];
extern const u32 gFollowMonShinyPalette_ToxtricityMegaGmax[];
extern const u32 gFollowMonShinyPalette_CentiskorchMegaGmax[];
extern const u32 gFollowMonShinyPalette_HattereneMegaGmax[];
extern const u32 gFollowMonShinyPalette_GrimmsnarlMegaGmax[];
extern const u32 gFollowMonShinyPalette_AlcremieMegaGmax[];
extern const u32 gFollowMonShinyPalette_CopperajahMegaGmax[];
extern const u32 gFollowMonShinyPalette_DuraludonMegaGmax[];
extern const u32 gFollowMonShinyPalette_UrshifuOneMegaGmax[];
extern const u32 gFollowMonShinyPalette_UrshifuRapidMegaGmax[];
