...
#define MOVEMENT_ACTION_JUMP_VARIABLE_DOWN              0xAA
#define MOVEMENT_ACTION_JUMP_VARIABLE_UP                0xAB
#define MOVEMENT_ACTION_JUMP_VARIABLE_LEFT              0xAC
#define MOVEMENT_ACTION_JUMP_VARIABLE_RIGHT             0xAD
