...
{
    [BATTLE_TERRAIN_GRASS_DAY]      = MOVE_ENERGY_BALL,
    [BATTLE_TERRAIN_GRASS_TWILIGHT]      = MOVE_ENERGY_BALL,
    [BATTLE_TERRAIN_GRASS_NIGHT]      = MOVE_ENERGY_BALL,
    [BATTLE_TERRAIN_LONG_GRASS_DAY] = MOVE_ENERGY_BALL,
    [BATTLE_TERRAIN_LONG_GRASS_TWILIGHT] = MOVE_ENERGY_BALL,
    [BATTLE_TERRAIN_LONG_GRASS_NIGHT] = MOVE_ENERGY_BALL,
    [BATTLE_TERRAIN_SAND_DAY]       = MOVE_EARTH_POWER,
    [BATTLE_TERRAIN_SAND_TWILIGHT]       = MOVE_EARTH_POWER,
    [BATTLE_TERRAIN_SAND_NIGHT]       = MOVE_EARTH_POWER,
    [BATTLE_TERRAIN_WATER_DAY]      = MOVE_HYDRO_PUMP,
    [BATTLE_TERRAIN_WATER_TWILIGHT]      = MOVE_HYDRO_PUMP,
    [BATTLE_TERRAIN_WATER_NIGHT]      = MOVE_HYDRO_PUMP,
    [BATTLE_TERRAIN_POND_DAY]       = MOVE_HYDRO_PUMP,
    [BATTLE_TERRAIN_POND_TWILIGHT]       = MOVE_HYDRO_PUMP,
    [BATTLE_TERRAIN_POND_NIGHT]       = MOVE_HYDRO_PUMP,
    [BATTLE_TERRAIN_MOUNTAIN_DAY]   = MOVE_EARTH_POWER,
    [BATTLE_TERRAIN_MOUNTAIN_TWILIGHT]   = MOVE_EARTH_POWER,
    [BATTLE_TERRAIN_MOUNTAIN_NIGHT]   = MOVE_EARTH_POWER,
    [BATTLE_TERRAIN_CAVE]       = MOVE_EARTH_POWER,
    [BATTLE_TERRAIN_CAVE_WATER]       = MOVE_WATERFALL,
    [BATTLE_TERRAIN_ICE_CAVE]       = MOVE_ICE_BEAM,
    [BATTLE_TERRAIN_ICE]       = MOVE_ICE_BEAM,
    [BATTLE_TERRAIN_BUILDING_DAY]   = MOVE_TRI_ATTACK,
    [BATTLE_TERRAIN_BUILDING_TWILIGHT]   = MOVE_TRI_ATTACK,
    [BATTLE_TERRAIN_BUILDING_NIGHT]   = MOVE_TRI_ATTACK,
...
static const u8 sTerrainToType[BATTLE_TERRAIN_COUNT] =
{
    ...
    [BATTLE_TERRAIN_MOUNTAIN_DAY]         = TYPE_GROUND,
    [BATTLE_TERRAIN_MOUNTAIN_TWILIGHT]         = TYPE_GROUND,
    [BATTLE_TERRAIN_MOUNTAIN_NIGHT]         = TYPE_GROUND,
        ...
        if (gBattleControllerExecFlags == 0)
        {
            ...
            if (gExpShareCheck == ((gBattleStruct->sentInPokes & (1 << gBattleStruct->expGetterMonId)) != 0))
            {
                ...
                gBattleMoveDamage = 0; // used for exp
                  ...
                  || GetMonData(&gPlayerParty[gBattleStruct->expGetterMonId], MON_DATA_LEVEL) == MAX_LEVEL || GetMonData(&gPlayerParty[gBattleStruct->expGetterMonId], MON_DATA_LEVEL) >= GetCurrentLevelCap())
            {
                gBattleScripting.getexpState = 5;
                gBattleMoveDamage = 0; // used for exp
        ...
        case 0:
            {
                ...
                if (lastMonLevel == 0) {
                    lastMonLevel = GetCurrentLevelCap();
                }
            }
            break;
...
u16 GetSecretPowerMoveEffect(void)
{
    ...
    else
    {
        ...
        case BATTLE_TERRAIN_GRASS_DAY:      moveEffect = MOVE_EFFECT_SLEEP; break;
        case BATTLE_TERRAIN_UNDERWATER: moveEffect = MOVE_EFFECT_ATK_MINUS_1; break;
        case BATTLE_TERRAIN_POND_DAY:       moveEffect = MOVE_EFFECT_ATK_MINUS_1; break;
        case BATTLE_TERRAIN_MOUNTAIN_DAY:   moveEffect = MOVE_EFFECT_ACC_MINUS_1; break;
        ...
        case BATTLE_TERRAIN_UNDERWATER: moveEffect = MOVE_EFFECT_DEF_MINUS_1; break;
        case BATTLE_TERRAIN_POND_DAY:       moveEffect = MOVE_EFFECT_ATK_MINUS_1; break;
        case BATTLE_TERRAIN_MOUNTAIN_DAY:   moveEffect = MOVE_EFFECT_FLINCH; break;
        case BATTLE_TERRAIN_PUDDLE:     moveEffect = MOVE_EFFECT_ACC_MINUS_1; break;
    #else
        case BATTLE_TERRAIN_GRASS_DAY:      moveEffect = MOVE_EFFECT_POISON; break;
        case BATTLE_TERRAIN_UNDERWATER: moveEffect = MOVE_EFFECT_DEF_MINUS_1; break;
        case BATTLE_TERRAIN_POND_DAY:       moveEffect = MOVE_EFFECT_SPD_MINUS_1; break;
        case BATTLE_TERRAIN_MOUNTAIN_DAY:   moveEffect = MOVE_EFFECT_CONFUSION; break;
        case BATTLE_TERRAIN_PUDDLE:     moveEffect = MOVE_EFFECT_ACC_MINUS_1; break;
    #endif
