...
const struct CompressedSpriteSheet gTrainerFrontPicTable[] =
{
    ...
    TRAINER_SPRITE(LEADER_SURGE, gTrainerFrontPic_Surge, 0x800),
    TRAINER_SPRITE(LEADER_ERIKA, gTrainerFrontPic_Erika, 0x800),
    TRAINER_SPRITE(LEADER_JANINE, gTrainerFrontPic_Janine, 0x800),
    TRAINER_SPRITE(LEADER_SABRINA, gTrainerFrontPic_Sabrina, 0x800),
    TRAINER_SPRITE(LEADER_BLAINE, gTrainerFrontPic_Blaine, 0x800),
    TRAINER_SPRITE(LEADER_GIOVANNI, gTrainerFrontPic_Giovanni, 0x800),
    TRAINER_SPRITE(LEADER_FALKNER, gTrainerFrontPic_Falkner, 0x800),
    TRAINER_SPRITE(LEADER_BUGSY, gTrainerFrontPic_Bugsy, 0x800),
    TRAINER_SPRITE(LEADER_WHITNEY, gTrainerFrontPic_Whitney, 0x800),
    ...
    TRAINER_SPRITE(LEADER_TATE, gTrainerFrontPic_Tate, 0x800),
    TRAINER_SPRITE(LEADER_LIZA, gTrainerFrontPic_Liza, 0x800),
    TRAINER_SPRITE(LEADER_ROARK, gTrainerFrontPic_Roark, 0x800),
    TRAINER_SPRITE(LEADER_GARDENIA, gTrainerFrontPic_Gardenia, 0x800),
    TRAINER_SPRITE(LEADER_MAYLENE, gTrainerFrontPic_Maylene, 0x800),
    TRAINER_SPRITE(LEADER_WAKE, gTrainerFrontPic_Wake, 0x800),
    TRAINER_SPRITE(LEADER_FANTINA, gTrainerFrontPic_Fantina, 0x800),
    TRAINER_SPRITE(LEADER_BYRON, gTrainerFrontPic_Byron, 0x800),
    TRAINER_SPRITE(LEADER_CANDICE, gTrainerFrontPic_Candice, 0x800),
    TRAINER_SPRITE(LEADER_VOLKNER, gTrainerFrontPic_Volkner, 0x800),
    TRAINER_SPRITE(LEADER_CILAN, gTrainerFrontPic_Cilan, 0x800),
    TRAINER_SPRITE(LEADER_CHILI, gTrainerFrontPic_Chili, 0x800),
    TRAINER_SPRITE(LEADER_CRESS, gTrainerFrontPic_Cress, 0x800),
    TRAINER_SPRITE(LEADER_LENORA, gTrainerFrontPic_Lenora, 0x800),
    TRAINER_SPRITE(LEADER_BURGH, gTrainerFrontPic_Burgh, 0x800),
    TRAINER_SPRITE(LEADER_ELESA, gTrainerFrontPic_Elesa, 0x800),
    TRAINER_SPRITE(LEADER_CLAY, gTrainerFrontPic_Clay, 0x800),
    TRAINER_SPRITE(LEADER_SKYLA, gTrainerFrontPic_Skyla, 0x800),
    TRAINER_SPRITE(LEADER_BRYCEN, gTrainerFrontPic_Brycen, 0x800),
    TRAINER_SPRITE(LEADER_DRAYDEN, gTrainerFrontPic_Drayden, 0x800),
    TRAINER_SPRITE(LEADER_CHEREN, gTrainerFrontPic_Cheren, 0x800),
    TRAINER_SPRITE(LEADER_ROXIE, gTrainerFrontPic_Roxie, 0x800),
...
const struct CompressedSpritePalette gTrainerFrontPicPaletteTable[] =
{
    ...
    TRAINER_PAL(G_ADMIN_MARS, gTrainerPalette_G_Admin_Mars),
    TRAINER_PAL(G_ADMIN_JUPITER, gTrainerPalette_G_Admin_Jupiter),
