static const struct FormChange sVenusaurFormChangeTable[] = {
    ...
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_VENUSAUR_MEGA_GMAX, ITEM_VENUSAURIMAX},
...
static const struct FormChange sCharizardFormChangeTable[] = {
    ...
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_CHARIZARD_MEGA_GMAX, ITEM_CHARIZARDIMAX},
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sBlastoiseFormChangeTable[] = {
    ...
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_BLASTOISE_MEGA_GMAX, ITEM_BLASTOISIMAX},
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sGengarFormChangeTable[] = {
    ...
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_GENGAR_MEGA_GMAX, ITEM_GENGARIMAX},
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sBurmyFormChangeTable[] = {
    {FORM_CHANGE_END_BATTLE_TERRAIN, SPECIES_BURMY,             BATTLE_TERRAIN_GRASS_DAY},
    {FORM_CHANGE_END_BATTLE_TERRAIN, SPECIES_BURMY,             BATTLE_TERRAIN_GRASS_TWILIGHT},
    {FORM_CHANGE_END_BATTLE_TERRAIN, SPECIES_BURMY,             BATTLE_TERRAIN_GRASS_NIGHT},
    {FORM_CHANGE_END_BATTLE_TERRAIN, SPECIES_BURMY,             BATTLE_TERRAIN_LONG_GRASS_DAY},
    {FORM_CHANGE_END_BATTLE_TERRAIN, SPECIES_BURMY,             BATTLE_TERRAIN_LONG_GRASS_TWILIGHT},
    {FORM_CHANGE_END_BATTLE_TERRAIN, SPECIES_BURMY,             BATTLE_TERRAIN_LONG_GRASS_NIGHT},
    {FORM_CHANGE_END_BATTLE_TERRAIN, SPECIES_BURMY,             BATTLE_TERRAIN_POND_DAY},
    {FORM_CHANGE_END_BATTLE_TERRAIN, SPECIES_BURMY,             BATTLE_TERRAIN_POND_TWILIGHT},
    {FORM_CHANGE_END_BATTLE_TERRAIN, SPECIES_BURMY,             BATTLE_TERRAIN_POND_NIGHT},
    {FORM_CHANGE_END_BATTLE_TERRAIN, SPECIES_BURMY,             BATTLE_TERRAIN_MOUNTAIN_DAY},
    {FORM_CHANGE_END_BATTLE_TERRAIN, SPECIES_BURMY,             BATTLE_TERRAIN_MOUNTAIN_TWILIGHT},
    {FORM_CHANGE_END_BATTLE_TERRAIN, SPECIES_BURMY,             BATTLE_TERRAIN_MOUNTAIN_NIGHT},
    ...
    {FORM_CHANGE_END_BATTLE_TERRAIN, SPECIES_BURMY_SANDY_CLOAK, BATTLE_TERRAIN_SAND_DAY},
    {FORM_CHANGE_END_BATTLE_TERRAIN, SPECIES_BURMY_SANDY_CLOAK, BATTLE_TERRAIN_SAND_TWILIGHT},
    {FORM_CHANGE_END_BATTLE_TERRAIN, SPECIES_BURMY_SANDY_CLOAK, BATTLE_TERRAIN_SAND_NIGHT},
    {FORM_CHANGE_END_BATTLE_TERRAIN, SPECIES_BURMY_TRASH_CLOAK, BATTLE_TERRAIN_BUILDING_DAY},
    {FORM_CHANGE_END_BATTLE_TERRAIN, SPECIES_BURMY_TRASH_CLOAK, BATTLE_TERRAIN_BUILDING_TWILIGHT},
    {FORM_CHANGE_END_BATTLE_TERRAIN, SPECIES_BURMY_TRASH_CLOAK, BATTLE_TERRAIN_BUILDING_NIGHT},
    {FORM_CHANGE_TERMINATOR},
};
...
static const struct FormChange sButterfreeFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_BUTTERFREE_MEGA_GMAX, ITEM_BUTTERMAX},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sPikachuFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_PIKACHU_MEGA_GMAX, ITEM_PIKACHUMAX},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sMachampFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_MACHAMP_MEGA_GMAX, ITEM_MACHAPMAX},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sKinglerFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_KINGLER_MEGA_GMAX, ITEM_KINGLEMAX},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sLaprasFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_LAPRAS_MEGA_GMAX, ITEM_LAPRAMAX},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sEeveeFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_EEVEE_MEGA_GMAX, ITEM_EEVEEMAX},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sSnorlaxFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_SNORLAX_MEGA_GMAX, ITEM_SNORLAXMAX},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sGarbodorFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_GARBODOR_MEGA_GMAX, ITEM_GARBOMAX},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sMelmetalFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_MELMETAL_MEGA_GMAX, ITEM_MELMEMAX},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sRillaboomFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_RILLABOOM_MEGA_GMAX, ITEM_RILLAMAX},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sCinderaceFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_CINDERACE_MEGA_GMAX, ITEM_CINDERMAX},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sInteleonFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_INTELEON_MEGA_GMAX, ITEM_INTELMAX},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sCorviknightFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_CORVIKNIGHT_MEGA_GMAX, ITEM_CORVIMAX},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sOrbeetleFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_ORBEETLE_MEGA_GMAX, ITEM_ORBEETMAX},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sDrednawFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_DREDNAW_MEGA_GMAX, ITEM_DREDMAX},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sCoalossalFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_COALOSSAL_MEGA_GMAX, ITEM_COALOSMAX},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sFlappleFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_FLAPPLE_MEGA_GMAX, ITEM_FLAPMAX},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sAppletunFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_APPLETUN_MEGA_GMAX, ITEM_APPLEMAX},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sSandacondaFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_APPLETUN_MEGA_GMAX, ITEM_SANDAMAX},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sToxtricityFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_SANDACONDA_MEGA_GMAX, ITEM_TOXIMAX},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sCentiskorchFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_TOXTRICITY_MEGA_GMAX, ITEM_CENTIMAX},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sHattereneFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_CENTISKORCH_MEGA_GMAX, ITEM_HATTEMAX},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sGrimsnarlFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_HATTERENE_MEGA_GMAX, ITEM_GRIMMAX},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sAlcremieFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_GRIMMSNARL_MEGA_GMAX, ITEM_ALCREMAX},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sCopperajahFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_ALCREMIE_MEGA_GMAX, ITEM_COPPERMAX},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sDuraludonFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_COPPERAJAH_MEGA_GMAX, ITEM_DURAMAX},
    {FORM_CHANGE_TERMINATOR},
};

static const struct FormChange sUrshifuFormChangeTable[] = {
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_URSHIFU_RAPID_MEGA_GMAX, ITEM_RAPID_SCROLL},
    {FORM_CHANGE_BATTLE_MEGA_EVOLUTION_ITEM,    SPECIES_URSHIFU_ONE_MEGA_GMAX, ITEM_ONE_STRIKE_SCROLL},
    {FORM_CHANGE_TERMINATOR},
};
#endif
