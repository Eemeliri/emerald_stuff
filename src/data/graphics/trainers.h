...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(TRAINER_PIC_GGRUNT_F, gTrainerFrontPic_GalacticGruntF, gTrainerPalette_GalacticGruntF),
    TRAINER_SPRITE(TRAINER_PIC_GGRUNT_M, gTrainerFrontPic_GalacticGruntM, gTrainerPalette_GalacticGruntM),
    TRAINER_SPRITE(TRAINER_PIC_G_ADMIN_SATURN, gTrainerFrontPic_GalacticAdminSaturn, gTrainerPalette_GalacticAdminSaturn),
    TRAINER_SPRITE(TRAINER_PIC_G_ADMIN_MARS, gTrainerFrontPic_GalacticAdminMars, gTrainerPalette_GalacticAdminMars),
    TRAINER_SPRITE(TRAINER_PIC_G_ADMIN_JUPITER, gTrainerFrontPic_GalacticAdminJupiter, gTrainerPalette_GalacticAdminJupiter),
    TRAINER_SPRITE(TRAINER_PIC_GHOST, gTrainerFrontPic_Ghost, gTrainerPalette_Ghost),
    TRAINER_SPRITE(TRAINER_PIC_LAWRENCE, gTrainerFrontPic_Lawrence, gTrainerPalette_Lawrence),
