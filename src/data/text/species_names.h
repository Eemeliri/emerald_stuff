const u8 gSpeciesNames[NUM_SPECIES][POKEMON_NAME_LENGTH + 1] = {
    ...
    [SPECIES_PIKACHU_MEGA_GMAX] = _("Pikachu"),
    [SPECIES_MACHAMP_MEGA_GMAX] = _("Machamp"),
    [SPECIES_GENGAR_MEGA_GMAX] = _("Gengar"),
    [SPECIES_KINGLER_MEGA_GMAX] = _("Kingler"),
    [SPECIES_LAPRAS_MEGA_GMAX] = _("Lapras"),
    [SPECIES_EEVEE_MEGA_GMAX] = _("Eevee"),
    [SPECIES_SNORLAX_MEGA_GMAX] = _("Snorlax"),
    [SPECIES_GARBODOR_MEGA_GMAX] = _("Garbodor"),
    [SPECIES_MELMETAL_MEGA_GMAX] = _("Melmetal"),
    [SPECIES_RILLABOOM_MEGA_GMAX] = _("Rillaboom"),
    [SPECIES_CINDERACE_MEGA_GMAX] = _("Cinderace"),
    [SPECIES_INTELEON_MEGA_GMAX] = _("Inteleon"),
    [SPECIES_CORVIKNIGHT_MEGA_GMAX] = _("Corviknigh"),
    [SPECIES_ORBEETLE_MEGA_GMAX] = _("Orbeetle"),
    [SPECIES_DREDNAW_MEGA_GMAX] = _("Drednaw"),
    [SPECIES_COALOSSAL_MEGA_GMAX] = _("Coalossal"),
    [SPECIES_FLAPPLE_MEGA_GMAX] = _("Flapple"),
    [SPECIES_APPLETUN_MEGA_GMAX] = _("Appletun"),
    [SPECIES_SANDACONDA_MEGA_GMAX] = _("Sandaconda"),
    [SPECIES_TOXTRICITY_MEGA_GMAX] = _("Toxtricity"),
    [SPECIES_CENTISKORCH_MEGA_GMAX] = _("Centiskorc"),
    [SPECIES_HATTERENE_MEGA_GMAX] = _("Hatterene"),
    [SPECIES_GRIMMSNARL_MEGA_GMAX] = _("Grimmsnarl"),
    [SPECIES_ALCREMIE_MEGA_GMAX] = _("Alcremie"),
    [SPECIES_COPPERAJAH_MEGA_GMAX] = _("Copperajah"),
    [SPECIES_DURALUDON_MEGA_GMAX] = _("Duraludon"),
    [SPECIES_URSHIFU_ONE_MEGA_GMAX] = _("Urshifu"),
    [SPECIES_URSHIFU_RAPID_MEGA_GMAX] = _("Urshifu"),
