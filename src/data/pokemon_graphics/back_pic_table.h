...
#endif
#if P_GEN_8_POKEMON == TRUE
    SPECIES_SPRITE(VENUSAUR_MEGA_GMAX, gMonBackPic_VenusaurMegaGmax),
    SPECIES_SPRITE(CHARIZARD_MEGA_GMAX, gMonBackPic_CharizardMegaGmax),
    SPECIES_SPRITE(BLASTOISE_MEGA_GMAX, gMonBackPic_BlastoiseMegaGmax),
    SPECIES_SPRITE(BUTTERFREE_MEGA_GMAX, gMonBackPic_ButterfreeMegaGmax),
    SPECIES_SPRITE(PIKACHU_MEGA_GMAX, gMonBackPic_PikachuMegaGmax),
    SPECIES_SPRITE(MACHAMP_MEGA_GMAX, gMonBackPic_MachampMegaGmax),
    SPECIES_SPRITE(GENGAR_MEGA_GMAX, gMonBackPic_GengarMegaGmax),
    SPECIES_SPRITE(KINGLER_MEGA_GMAX, gMonBackPic_KinglerMegaGmax),
    SPECIES_SPRITE(LAPRAS_MEGA_GMAX, gMonBackPic_LaprasMegaGmax),
    SPECIES_SPRITE(EEVEE_MEGA_GMAX, gMonBackPic_EeveeMegaGmax),
    SPECIES_SPRITE(SNORLAX_MEGA_GMAX, gMonBackPic_SnorlaxMegaGmax),
    SPECIES_SPRITE(GARBODOR_MEGA_GMAX, gMonBackPic_GarbodorMegaGmax),
    SPECIES_SPRITE(MELMETAL_MEGA_GMAX, gMonBackPic_MelmetalMegaGmax),
    SPECIES_SPRITE(RILLABOOM_MEGA_GMAX, gMonBackPic_RillaboomMegaGmax),
    SPECIES_SPRITE(CINDERACE_MEGA_GMAX, gMonBackPic_CinderaceMegaGmax),
    SPECIES_SPRITE(INTELEON_MEGA_GMAX, gMonBackPic_InteleonMegaGmax),
    SPECIES_SPRITE(CORVIKNIGHT_MEGA_GMAX, gMonBackPic_CorviknightMegaGmax),
    SPECIES_SPRITE(ORBEETLE_MEGA_GMAX, gMonBackPic_OrbeetleMegaGmax),
    SPECIES_SPRITE(DREDNAW_MEGA_GMAX, gMonBackPic_DrednawMegaGmax),
    SPECIES_SPRITE(COALOSSAL_MEGA_GMAX, gMonBackPic_CoalossalMegaGmax),
    SPECIES_SPRITE(FLAPPLE_MEGA_GMAX, gMonBackPic_FlappleMegaGmax),
    SPECIES_SPRITE(APPLETUN_MEGA_GMAX, gMonBackPic_AppletunMegaGmax),
    SPECIES_SPRITE(SANDACONDA_MEGA_GMAX, gMonBackPic_SandacondaMegaGmax),
    SPECIES_SPRITE(TOXTRICITY_MEGA_GMAX, gMonBackPic_ToxtricityMegaGmax),
    SPECIES_SPRITE(CENTISKORCH_MEGA_GMAX, gMonBackPic_CentiskorchMegaGmax),
    SPECIES_SPRITE(HATTERENE_MEGA_GMAX, gMonBackPic_HattereneMegaGmax),
    SPECIES_SPRITE(GRIMMSNARL_MEGA_GMAX, gMonBackPic_GrimmsnarlMegaGmax),
    SPECIES_SPRITE(ALCREMIE_MEGA_GMAX, gMonBackPic_AlcremieMegaGmax),
    SPECIES_SPRITE(COPPERAJAH_MEGA_GMAX, gMonBackPic_CopperajahMegaGmax),
    SPECIES_SPRITE(DURALUDON_MEGA_GMAX, gMonBackPic_DuraludonMegaGmax),
    SPECIES_SPRITE(URSHIFU_RAPID_MEGA_GMAX, gMonBackPic_UrshifuRapidMegaGmax),
    SPECIES_SPRITE(URSHIFU_ONE_MEGA_GMAX, gMonBackPic_UrshifuOneMegaGmax),
